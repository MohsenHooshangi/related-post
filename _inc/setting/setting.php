<?php
function wp_rp_related_posts_admin_layout(){
   if(!current_user_can('manage_options')){
       return;
   }
   if(isset($_GET['settings-update'])){
       add_settings_error('setting','setting-message','تنطیمات ذخیره گردید','update');
   }
   settings_errors('setting-message');
   

?>
<div class="wrap rp_wrapper">
...
/*    register_setting('related-post','_rp_title',$args);
    ...
    foreach ( $settings_array as $setting_array) register_setting('related-post',$setting_array,$args);
    
    add_settings_section('rp_settings_section',
        '',
        '',
        'related-post-html'
    );
    add_settings_field('rp_settings_field',
        '',
        'rp_render_html',
        'related-post-html',
        'rp_settings_section'
...
add_action('admin_init','wp_rp_setting_init');
...
function rp_render_html(){
    ...
    <div class="element-wrapper">
        ...
        <select name="_rp_according_to" id="according_to">
